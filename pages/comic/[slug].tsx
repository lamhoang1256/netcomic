              ...
              <div className="md:flex gap-x-[15px] mt-5">
                ...
                <div className="md:w-[70%]">
                  <ul>
                    ...
                    <li className="flex items-center mt-[10px] gap-x-1">
              ...
              <div className="mt-5">
                ...
                <div className="mt-4">
                  <div className="flex text-base font-semibold">
                    <span className="w-1/2">Số chương</span>
                    <span className="w-1/4 text-center">Cập nhật</span>
                    <span className="w-1/4 text-center">Lượt xem</span>
                  </div>
                  <ul className="border border-[#080808] pt-[6px] pr-[6px] pl-[10px] rounded mt-[10px] pb-4">
                    {chapters.slice(0, countChapters).map((chapter) => (
                      <li
                        ...
                        key={chapter.id}
                      >
                        <span className="w-1/2">{chapter.title}</span>
                        <span className="w-1/4 text-center italic text-[#c0c0c0]">
                          {chapter.updatedAt}
                        </span>
                        <span className="w-1/4 text-center italic text-[#c0c0c0]">
                          {chapter.viewCount}
